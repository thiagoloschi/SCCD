...
public class IgLogin extends JDialog {
	...
	/**
	 * Cria e exibe uma caixa de di�logo para obter o login do usu�rio.
	 */
	public IgLogin(SuperDiaApp superDiaApp) {
		...
		//tratando o evento foco entrar cursor mouse colocando o cursor do mouse como uma m�o.
		entrarButton.addMouseListener(trataEventosIgLogin.new TrataEventoFocoMouseEntrarButton());
		
		// tratando o evento do bot�o Entrar
